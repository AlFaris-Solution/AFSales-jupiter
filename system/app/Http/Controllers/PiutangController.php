...
class PiutangController extends Controller
{
	...
	public function data()
    {
        ...
        $roles = DB::table('piutangs')
                 ...
                 ->orderBy('piutangs.created_at', 'DESC')
        ...
        return DataTables::of($roles)
               ->addColumn('action', function ($role) {
                return
                  '<div class="text-center btn-group btn-group-justified"><a href="piutang/detail/'.$role->id.'" title="Detail Data piutang" style="display: none;"><button type="button" class="btn btn-sm btn-success"><i class="fa fa-search"></i></button></a> <a href="piutang/print/'.$role->id.'"  style="display: none;" title="Print Data piutang"><button type="button" class="btn btn-sm btn-default"><i class="fa fa-print"></i></button></a> <a href="piutang/delete/'.$role->id.'" title="Delete" Onclick="return ConfirmDelete();"><button type="button" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></button></a></div>';
            })
            ->make(true);
    }
    ...
    public function create(Request $request)
    {
        ...
        $faktur_list = Penjualan::with('kontak')->get();
    ...
    public function findPrice(Request $request)
    {
        ...
        $data = Penjualan::select('saldo_terutang')->where(['id' => $request->id])->where(['kontak_id' => $request->kontak_id])->first();
