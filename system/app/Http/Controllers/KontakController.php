...
class KontakController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kontak.index', compact('kontak','products','uoms','kategori','kategori_list','departement_list'));
    ...
    public function create()
    {
        ...
        $departement_list = Departement::pluck('nama_departement','id');
        return view('kontak.create',compact('departement_list'));
        
    }

    public function tambahKoordinator(Request $request)
    {
        $data = Kontak::create([
