...
class PembayaranController extends Controller
{
        ...
        return DataTables::of($roles)
               ->addColumn('action', function ($role) {
                ...
                '<div class="text-center btn-group btn-group-justified">
                    <a href="pembayaran/detail/'.$role->id.'" title="Detail Data pembayaran">
                        <button type="button" class="btn btn-sm btn-success"><i class="fa fa-search"></i></button>
                    </a><a href="pembayaran/delete/'.$role->id.'" title="Delete" Onclick="return ConfirmDelete();">
    ...
    public function detail($id){
        ...
        $pembayaran_detail = pembayaranDetail::find($id);
        $pembelian_detail = pembelianDetail::where('pembelian_id', $pembayaran_detail['pembelian_id'])->get();

        return view('modules.pembayaran.detail')->with([
