...
class HargaBeliController extends Controller
{
    ...
    public function index()
    {
        ...
        $roles = DB::table('hargabeli')
                 ...
                 ->orderBy('hargabeli.id', 'DESC')
                 ->get()
                 ;

        return view('kontak.hargabeli.index', compact('harga','kontak','hargadetail', 'roles')); 
    }
    ...
    public function data()
    {
        ...
        return DataTables::of($roles)
               ->addColumn('action', function ($role) {
                return
                  '<div class="text-center btn-group btn-group-justified"><a href="'.route('hargabeli.edit',[$role->id]).'" title="Edit"><button type="button" value="'.$role->id.'" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i></button></a> 
                  <form method="post" id="form-delete" action="'.route('hargabeli.destroy', $role->id).'">
                    <input type="hidden" name="_token" value="csrf-token">
                    <input type="hidden" name="_method" value="DELETE">
                    <button type="button" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></button></div>
                  </form>';
            })
            ->make(true);
    } 
    ...
    {
        $hargabeli = HargaBeli::where('id', '=', $id)->delete();
        return back();
    }
