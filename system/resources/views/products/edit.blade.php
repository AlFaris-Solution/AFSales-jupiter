...
<div class="col-xs-12">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
                ...
                {{-- <div class="form-group">
                    <label for="lama_angsuran" class="col-sm-2 control-label">Settingan Harga Kredit</label>
                    <div class="col-sm-4">
                        @php
                            $count = !empty($setting_angsuran) ? $setting_angsuran->count() : 0;
                        @endphp
                        @foreach ($setting_angsuran as $key => $list)
                            @if ($key+1 == $count)
                                <div class="row" id="content-credit">
                            @else
                                <div class="row">
                            @endif
                                <input type="hidden" name="id[]" value="{{ $list->id }}">
                                <div class="col-sm-3">
                                    <input type="number" class="form-control" name="lama_angsuran[]" id="lama_angsuran" min="1" max="36" placeholder="Lama Angsuran" required value="{{ $list->lama_angsuran }}">
                                </div>
                                <div class="col-sm-7">
                                    <input type="number" class="form-control" name="nominal_angsuran[]" id="nominal_angsuran" placeholder="Nominal Angsuran" required value="{{ $list->nominal_angsuran }}">
                                </div>
                                <br><br>
                            </div>
                        @endforeach
                        ...
                        <div class="row" id="content-credit">
                            <div class="col-sm-3">
                                <input type="number" class="form-control" name="lama_angsuran[]" id="lama_angsuran" min="1" max="36" placeholder="Lama Angsuran" required>
                            </div>
                            <div class="col-sm-7">
                    ...
                    <div class="col-sm-1">
                        <button type="button" class="btn btn-success" id="tambah-settingan"><i class="fa fa-plus-circle"></i></button>
                    </div>
                </div> --}}
                ...
                {{-- <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="number" class="form-control" id="dp" name="dp" value="{{ $products->dp }}">
                    </div>
                </div> --}}
