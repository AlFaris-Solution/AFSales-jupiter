...
<div class="col-xs-12">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
                ...
                <div class="item form-group">
                    {!! Form::label('harga_jual_reseller', 'Harga Jual Reseller', ['class' => 'col-sm-2 control-label']) !!}
                    <div class="col-sm-8">
                    {!! Form::text('harga_jual_reseller', old('harga_jual_reseller'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    </div>
                    <p class="help-block"></p>
                    @if($errors->has('harga_jual_reseller'))
                        <p class="help-block">
                            {{ $errors->first('harga_jual_reseller') }}
                        </p>
                    @endif
                </div>
                
                <div class="item form-group">
                    {!! Form::label('harga_jual_kredit', 'Harga Jual Kredit', ['class' => 'col-sm-2 control-label']) !!}
                    <div class="col-sm-8">
                    {!! Form::text('harga_jual_kredit', old('harga_jual_kredit'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    </div>
                    <p class="help-block"></p>
                    @if($errors->has('harga_jual_kredit'))
                        <p class="help-block">
                            {{ $errors->first('harga_jual_kredit') }}
                        </p>
                    @endif
                </div>
