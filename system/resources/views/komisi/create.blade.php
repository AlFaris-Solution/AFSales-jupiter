...
@section('content')
{!! Form::open(['method' => 'POST', 'route' => ['komisi.store'],'class' => 'form-horizontal']) !!}
    <div class="row">
        <div class="col-xs-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control datepicker" id="tgl_berubah" name="tgl_berubah" required 
                                value="{{ old('tgl_berubah') ?? date('d/m/Y') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="komisi_sales" class="col-sm-2 control-label">Komisi Sales</label>
                        <div class="col-sm-2">
                            <input type="number" class="form-control" id="komisi_sales" name="komisi_sales" required value="{{ old('komisi_sales') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="komisi_db" class="col-sm-2 control-label">Komisi DB</label>
                        <div class="col-sm-2">
                            <input type="number" class="form-control" id="komisi_db" name="komisi_db" required value="{{ old('komisi_db') }}">
                        </div>
                    </div>
                    <div class="form-group">
