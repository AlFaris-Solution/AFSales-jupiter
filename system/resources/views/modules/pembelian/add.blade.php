    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body  table-responsive">
                ...
                <div class="form-group col-lg-6 form-input">
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control" name="tgl_jatuh_tempo" id="tgl_jatuh_tempo" placeholder="Tanggal Faktur" value="{{ date('d/m/Y') }}">
                        </div>
                        </div>
                        ...
                        {!! Form::text('keterangan', old('keterangan') ?? 'PEMBELIAN', ['class' => 'form-control', 'placeholder' => '']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tanggal_kirim" id="tanggal_kirim" placeholder="Tanggal Pengiriman" value="{{ date('d/m/Y') }}">
