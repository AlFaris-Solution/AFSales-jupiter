...
{!!Form::open(array('route'=>'pembayaran.insert','id'=>'frmsave', 'class'=>'form-horizontal','method'=>'post'))!!}
...
<div class="row">
	<div class="col-xs-12">
		...
		<div class="panel-body  table-responsive">	
                ...
                <div class="col-sm-4">
                {!! Form::select('kontak_id', $kontak_list, old('no_po'), ['class' => 'form-control select2', 'placeholder' => 'Pilih Penerima']) !!}
                </div>
        ...
        <div class="col-lg-2 col-sm-2">
            <div class="form-group">
                <a href="{{route('pembayaran.index')}}" class="btn btn-primary">Batal</a>
...
@push('javascripts')
    ...
    <script type="text/javascript">
        $('tbody').delegate('.no_faktur','change',function(){
            ...
            $.ajax({
                type    : 'GET',
                url     : '{!!URL::route('pembayaran.findTanggal')!!}',
                dataType: 'json',
                data    : dataId,                
        ...
        $('tbody').delegate('.no_faktur','change',function(){            
            ...
            $.ajax({
                type    : 'GET',
                url     : '{!!URL::route('pembayaran.findPrice')!!}',
                dataType: 'json',
                data    : dataId,
                success:function(data){
