...
{!!Form::open(array('route'=>'transfer.insert','id'=>'frmsave', 'class'=>'form-horizontal', 'method'=>'post'))!!}
	...
	<div class="col-xs-12">
		...
		<div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                <input type="text" class="form-control" name="tanggal" id="tanggal" placeholder="Tanggal Faktur" value="{{ date('d/m/Y') }}">                
                </div>
            </div>
            ...
            <div class="form-group">                
                {!! Form::label('gudang_asal', 'Dari Gudang :', array('class' => 'col-sm-2 control-label')) !!}
                <div class="col-sm-2">
            	...
            	<table class="table table-bordered">
	        		...
	        		<tbody>
	        			<tr id="item">
	        				...
	        				<td width="15%">
                            <select class="form-control ke_gudang" name="ke_gudang[]" id="ke_gudang">
                                <option value="0" selected="true" disabled="true">Pilih Gudang</option>
                                @foreach($gudang_list as $key => $p)   
                                <option value="{!!$key!!}">{!!$p!!}</option>
                                @endforeach
                                </select>
                            </td>
	        				<td width="10%"><input type="text" name="jobs[]" style="text-align: center;" class="form-control jobs"></td>
        ...
        <div class="col-lg-2 col-sm-2">
            <div class="form-group">
                <a href="{{route('transfer.index')}}" class="btn btn-primary">Batal</a>
...
--> 
    ...
    <script type="text/javascript">
        ...
        $('tbody').delegate('.nama_produk','change',function(){            
            ...
            $.ajax({
                type    : 'GET',
                url     : '{!!URL::route('transfer.findKodeProduk')!!}',
                dataType: 'json',
                data    : dataId,
        ...
        $('tbody').delegate('.nama_produk','change',function(){            
            ...
            $.ajax({
                type    : 'GET',
                url     : '{!!URL::route('transfer.findSatuan')!!}',
                dataType: 'json',
                data    : dataId,
                success:function(data){
        ...
        $('tbody').delegate('.nama_produk','change',function(){            
            ...
            $.ajax({
                type    : 'GET',
                url     : '{!!URL::route('transfer.findPrice')!!}',
                dataType: 'json',
                data    : dataId,
                success:function(data){
