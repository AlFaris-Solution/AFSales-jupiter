        ...
        <div class="panel-body">
            ...
            <thead>
                <tr>
                    ...
                    <th width="25%" style="text-align: left;">Gudang Asal</th>
                </tr>
            </thead>
            <?php $no = 0;?>
            <?php $total = 0; ?>
            ...
            <?php $no++ ;?>
                <tr>
                    ...
                    <?php
                      ...
                      $gudang = App\Gudang::where('id', $pembelian->gudang_asal)->select('nama_gudang')->first();
                    ...
                    <td style="text-align: left;">{!! $gudang->nama_gudang ?? '<span class="label label-danger">Belum Teridentifikasi</span>' !!}</td>                                 
                </tr>
            </tbody>
            @endforeach
            <tfoot> 
