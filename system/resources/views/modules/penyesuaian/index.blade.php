...
<div class="row">
    ...
    <p>
        <div class="btn-group">
              <a href="{{route('penyesuaian.create')}}" class="btn btn-info">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            @lang('global.app_list') Penyesuaian Persediaan
        </div>
                ...
                <table id="list" class="table table-bordered table-striped table-condensed">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center" width="15%">No. Referensi</th>
