...
{!!Form::open(array('route'=>'kas.pengeluaran.insert','id'=>'frmsave', 'class'=>'form-horizontal', 'method'=>'post'))!!}
...
<div class="row">
	<div class="col-xs-12">
        ...
        <div class="col-lg-2 col-sm-2">
            <div class="form-group">
                <a href="{{route('kas.pengeluaran.index')}}" class="btn btn-primary">Batal</a>
...
--> 
    ...
    <script type="text/javascript">
        ...
        $('tbody').delegate('.nama_akun2','change',function(){   
            ...
            $.ajax({
                type    : 'GET',
                url     : '{!!URL::route('kas.pengeluaran.findKodeProduk')!!}',
                dataType: 'json',
                data    : dataId,
        ...
        $('tbody').delegate('.nama_akun2','change',function(){            
            ...
            $.ajax({
                type    : 'GET',
                url     : '{!!URL::route('kas.pengeluaran.findSatuan')!!}',
                dataType: 'json',
                data    : dataId,
                success:function(data){
        ...
        $('tbody').delegate('.nama_akun2','change',function(){            
            ...
            $.ajax({
                type    : 'GET',
                url     : '{!!URL::route('kas.pengeluaran.findPrice')!!}',
                dataType: 'json',
                data    : dataId,
                success:function(data){
