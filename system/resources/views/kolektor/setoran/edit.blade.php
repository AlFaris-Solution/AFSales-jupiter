            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body table-responsive">
                        ...
                        <div class="col-sm-2">
                            <select name="kolektor" id="kolektor" class="form-control" required>
                                ...
                                @foreach ($kolektor as $list)
                                    <option value="{{ $list->id }}" {{ $list->id == $lhiSetoran['lhi']['kolektor'] ? 'selected' : '' }}>{{ $list->nama_kontak }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control datepicker" id="tgl_angsuran" name="tgl_angsuran" required value="{{ $lhiSetoran->tgl_angsuran }}">
