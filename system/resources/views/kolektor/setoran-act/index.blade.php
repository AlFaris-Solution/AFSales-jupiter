    ...
    <div class="col-sm-12">
        <div class="row">
            <div class="col-sm-2 mt-1">
                <a href="{{ route('setoran-act.create') }}" class="btn btn-success">@lang('global.app_add_new')</a>
            </div>
                    ...
                    <tbody>
                        @foreach ($setoranAct as $key => $row)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('setoran-act.destroy', $row->id) }}" method="post">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="_method" value="delete">

                                        <a href="{{ route('setoran-act.edit', $row->id) }}" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
