        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body table-responsive">
                    ...
                    <div class="form-group">
                        <label for="tgl_kwitansi" class="col-sm-2 control-label">Tanggal Kwitansi</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control datepicker" id="tgl_kwitansi" name="tgl_kwitansi" value="{{ old('tgl_kwitansi') }}">
                        </div>
                    </div>
                    <div class="form-group">
    ...
    $('#no_kwitansi').on('change', function() {
        $.get({
            ...
            success: (data) => {
                ...
                $('#nominal_tagihan').val(data.total_angsuran)
                $('#tertagih').val(0)
                $('#sisa_tagihan').val(0)
            },
            error: (err) => {
