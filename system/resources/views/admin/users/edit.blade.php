...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    <label for="tlp" class="control-label col-xs-2">No Tlp*</label>
                    <div class="col-xs-10">
                        <input type="text" class="form-control" name="tlp" id="tlp" value="{{ $user->tlp }}">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <div class="col-xs-10">
                        <textarea name="alamat" id="alamat" rows="5" class="form-control">{{ $user->alamat }}</textarea>
                    </div>
                </div>
            </div>
