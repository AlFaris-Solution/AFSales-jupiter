...
<div class="col-xs-12">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            @lang('global.app_create') Data Kontak
        </div>
        ...
        <div class="panel-body table-responsive">
                ...
                <div class="form-group">
                    ...
                    {{ Form::select('tipe', [
                       ...
                       'Supplier' => 'Supplier',
                       'Customer' => 'Customer',
                       'Demo Boker' => 'Demo Booker',
                       'Seles' => 'Seles',
                       'Sales Suvervisor' => 'Sales Supervisor',
                       'Kolektor' => 'Kolektor',
                       'Koordinator' => 'Koordinator'], old('tipe'), ['class' => 'form-control', 'placeholder' => '']) }}
                    </div>
                 ...
                 {!! Form::label('jenis', 'Wilayah', ['class' => 'col-sm-2 control-label']) !!}
                    <div class="col-sm-4">
                    {!! Form::select('jenis',  [
                       'Cabang Majalengka' => 'Cabang Majalengka',
                       'Cabang Tangerang' => 'Cabang Tangerang',
                       'Cabang Sumedang' => 'Cabang Sumedang',
                       'Cabang Tegal' => 'Cabang Tegal',
                       'Cabang Garut' => 'Cabang Garut',
                       'Cabang Purwokerto' => 'Cabang Purwokerto',
