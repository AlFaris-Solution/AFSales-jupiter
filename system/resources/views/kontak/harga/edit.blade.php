...
@section('content')
    ...
    {!! Form::model($hargajual, ['method' => 'PUT', 'route' => ['hargajuals.update', $hargajual->id],'class' => 'form-horizontal']) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive"> 
                ...
                <div class="form-group">
                    {!! Form::label('kontak_id', 'Nama Pelanggan', ['class' => 'col-sm-2 control-label']) !!}
                    <div class="col-sm-10">
                    <?php 
                      $kontak = DB::table('kontaks')->where('id','=',$hargajual->kontak_id)->first();
                    ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <?php 
                      $produk = DB::table('products')->where('id','=',$hargajual->produk_id)->first();
                    ?>
...
<option value="{{ $val }}" {{ Input::old('uom_id') == $uoms ? 'selected="selected"' : '' }}>{{ $val }}</option>
                ...
                <div class="form-group">
                    {!! Form::label('harga_jual_standar', 'Harga Jual Standar', ['class' => 'col-sm-2 control-label']) !!}
                    <div class="col-sm-10">
                    {!! Form::text('harga_jual_standar', old('harga_jual_standar'), ['class' => 'form-control', 'readonly' => 'true']) !!}
                    </div>
                    <p class="help-block"></p>
                    @if($errors->has('harga_jual_standar'))
                        <p class="help-block">
                            {{ $errors->first('harga_jual_standar') }}
                        </p>
                    @endif
                </div>
                
                <div class="form-group">
                    {!! Form::label('harga_jual_pelanggan', 'Harga Jual Pelanggan', ['class' => 'col-sm-2 control-label']) !!}
                    <div class="col-sm-10">
                    {!! Form::text('harga_jual_pelanggan', old('harga_jual_pelanggan'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    </div>
                    <p class="help-block"></p>
                    @if($errors->has('harga_jual_pelanggan'))
                        <p class="help-block">
                            {{ $errors->first('harga_jual_pelanggan') }}
                        </p>
                    @endif
                </div>
                
        <div class="btn-group pull-right">
            <a href="{{ route('hargajuals.index') }}" class="btn btn-primary"><i class="fa fa-chevron-left fa-fw"></i> Back</a>
