...
<link rel="stylesheet" type="text/css" href="{{ asset('/bower_components/gentelella/vendors/datatables.net-select/select.dataTables.min.css') }}">
...
@section('content-header')
      <h1>
        @lang('global.hargabeli.title')
        <small>Add</small>
      </h1>

      <ol class="breadcrumb">
        <li><a href="{{url('/')}}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{url('kontak')}}"> @lang('global.hargabeli.title')</a></li>
        <li class="active">@lang('global.app_create')</li>
      </ol>    
@stop

@section('content')
    {!! Form::open(['method' => 'POST', 'route' => ['hargabeli.store'],'class' => 'form-horizontal']) !!}
...
<div class="col-xs-12">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">  
                ...
                {{ Form::label('nama_kontak', 'Nama Pemasok *', array('class' => 'col-sm-2 control-label')) }}
                <div class="col-sm-6">
                ...
                <table class="table table-no-bordered table-responsive" id="item_table">
                    <thead style="background: #696969;">
                        ...
                        <th class="warna-text" style="text-align: right;">Harga Beli</th>
                    ...
                    <tbody style="background: #eee;" class="item_body">
                        <tr class="item">
                            ...
                            <td width="20%">
                            <input type="text" name="harga_beli_khusus[]" style="text-align: right;" class="form-control input-sm" id="harga_beli_khusus">
                            </td>
...
<script type="text/javascript" src="{{ asset('/bower_components/gentelella/vendors/datatables.net-select/dataTables.select.min.js') }}"></script>
...
$(document).ready(function() {
    ...
    document.getElementById('btnx').onclick = function()
    {
      ...
      $.ajax({
                type    : 'GET',
                url     : '{!!URL::route('hargabeli.findProduk')!!}',
                dataType: 'json',
                data    : dataId,
...
$(document).ready(function() {
    ...
    document.getElementById('btn_kontakx').onclick = function()
    {
      ...
      $.ajax({
                type    : 'GET',
                url     : '{!!URL::route('hargabeli.findKontak')!!}',
                dataType: 'json',
                data    : dataId,
                success:function(data){
        ...
        function addRow()
        {
            var tr =  '<tr class="item">'+
                            ...
                            '<td width="15%">'+
                                ...
                                '@endforeach'+
                            '</td>'+                           
                            '<td width="20%"><input type="text" name="harga_beli_khusus[]" style="text-align: right;" class="form-control input-sm" id="harga_beli_khusus">'+
                            '</td>'+
