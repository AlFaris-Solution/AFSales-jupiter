                ...
                <div class="panel-body table-responsive">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xs-6" style="margin-top: .7em;">
                                    {!! Form::label('tanggal_faktur', 'Tanggal Faktur :', ['class' => 'control-label']) !!}
                                    <div class="input-group date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <input type="text" class="form-control" name="tanggal_faktur" id="tanggal_faktur" placeholder="Tanggal Faktur" value="{{ date('d/m/Y') }}">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-6" style="margin-top: .7em;">
                                    {!! Form::label('tanggal_jatuh_tempo', 'Tanggal Jatuh Tempo :', ['class' => 'control-label']) !!}
                                    <div class="input-group date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <input type="text" class="form-control" name="tanggal_jatuh_tempo" id="tanggal_jatuh_tempo" placeholder="Tanggal Jatuh Tempo" value="{{ date('d/m/Y') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xs-6" style="margin-top: .7em;">
                                    {!! Form::label('sales', 'Sales :', ['class' => 'control-label']) !!}
                                    <select name="sales" id="sales" class="form-control select2">
                                        @foreach ($sales_list as $list)
                                            <option value="{{ $list->id }}">{{ $list->nama_kontak }}{{ !empty($list->klasifikasi) ? " - $list->klasifikasi" : '' }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="row" style="margin-top: 2em;">
                        <div class="col-md-3 col-xs-12">
                            <div class="input-group">
                                <select id="select-val" class="form-control select2">
                                    @foreach ($product_list as $produk)
                                        <option value="{{ $produk->nama_produk }},{{ $produk->kode_produk }},{{ $produk->harga_jual_satuan }},{{ $produk->id }}">{{ $produk->nama_produk }} - {{ $produk->kode_produk }}</option>
                                    @endforeach
                                </select>
                                <span class="input-group-btn">
                                <button type="button" class="btn btn-success btn-md pull-right" id="add-to-list">Add To List</button>
                                </span>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody  style="background: #eee;" id="item_body" >
                                    <tr id="item_tr">
                                        ...
                                        <td width="10%"><input type="text" id="qty" name="qty[]" style="text-align: right;" class="form-control calcEvent input-sm totalsetelahpajak(); qty"></td>
                                            ...
                                            <td width="5%"><input type="text" name="qty_pesan[]" style="text-align: right;" class="form-control input-sm calcEvent totalsetelahpajak();  qty_pesan"></td>
                                            <!--
                                            <td width="8%">
                    ...
                    <div class="text-right">
                        <div class="form-group" style="vertical-align: middle;">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-12">
                                <input placeholder="0.0" name="biaya_lain" id="biaya_lain" class="biaya_lain form-control" type="text" style="text-align: right;" value="0">
