...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/chasier', 'PenjualanController@kasir');
    ...
    Route::get('products/import','ProductController@produkImport')->name('products.import');
     Route::post('products/import/store','ProductController@fileImport')->name('products.importfile');
    ...
    Route::post('/kontak/tambah-koordinator', 'KontakController@tambahKoordinator')->name('kontak.tambahKoordinator');
    ...
    */
    ...
    Route::resource('hargabeli','HargaBeliController')->except('data','show', 'create','list', 'destroy');
    Route::get('hargabeli','HargaBeliController@index')->name('hargabeli.index');
    Route::delete('hargabeli/{id}','HargaBeliController@destroy')->name('hargabeli.destroy');
    ...
    Route::get('penjualan/home', ['as' => 'penjualan.home', 'uses' => 'PenjualanController@home']);
    ...
    Route::get('penjualan/findProduk',array('as'=>'penjualan.findProduk','uses'=>'PenjualanController@findProduk'));
     Route::get('penjualan/get_produk','PenjualanController@getProduk')->name('penjualan.get_produk');
     
     Route::get('penjualan/jenis-harga',array('as'=>'penjualan.jenisHarga','uses'=>'PenjualanController@jenisharga'));
     Route::get('penjualan/harga-kredit',array('as'=>'penjualan.hargaKredit','uses'=>'PenjualanController@kredit'));
    

    Route::post('penjualan/insert',array('as'=>'penjualan.insert','uses'=>'PenjualanController@insert'));
    Route::get('penjualan/delete/{id}','PenjualanController@detailDelete')->name('penjualan.detailDelete');
    Route::get('penjualan/data/{keyword}','PenjualanController@keyword')->name('penjualan.keyword');
    ...
    // print others
    Route::get('penjualan/printsmall/{id}', 'PenjualanController@printSmall')->name('penjualan.printSmall');
    Route::get('penjualan/printmedium/{id}', 'PenjualanController@printMedium')->name('penjualan.printMedium');
    ...
    Route::get('penjualan/preorder/{id}', 'PenjualanController@preOrder')->name('penjualan.preOrder');
    Route::put('penjualan/detail/edit/{id}', 'PenjualanController@detailEdit')->name('penjualan.detailEdit');
    ...
    Route::resource('/gudang/histori-stok', 'HistoriStokController');
